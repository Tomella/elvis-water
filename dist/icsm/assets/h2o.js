 ...
 */
{
   angular.module("h2o.config", []).provider("configService", function ConfigServiceProvider() {
      ...
      this.$get = ['$q', '$http', 'waiting', function configServiceFactory($q, $http, waiting) {
         return {
            getConfig: function getConfig(child) {
 ...
 */
{
   ...
   angular.module("WaterApp", ['common.catchment', 'common.cc', 'common.header', 'common.navigation', 'common.scroll', 'common.storage', 'common.templates', 'common.toolbar',

   //'explorer.config',
   'explorer.confirm', 'explorer.drag', 'explorer.enter', 'explorer.flasher', 'explorer.googleanalytics', 'explorer.httpdata', 'explorer.info', 'explorer.message', 'explorer.modal', 'explorer.tabs', 'explorer.version', 'explorer.map.templates', 'exp.search.map.service', 'exp.ui.templates', 'geo.draw', 'geo.elevation', 'geo.geosearch', 'geo.map', 'geo.maphelper', 'geo.measure', 'h2o.catchment', 'h2o.config', 'h2o.contributors', 'h2o.download', 'h2o.list', 'h2o.panes', 'h2o.regions', 'h2o.side-panel', 'h2o.templates', 'h2o.toolbar', 'ui.bootstrap', 'ui.bootstrap-slider', 'ngAutocomplete', 'ngRoute', 'ngSanitize', 'page.footer'])
